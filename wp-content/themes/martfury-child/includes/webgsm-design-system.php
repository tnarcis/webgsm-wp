...
/* ============================================
   CATALOG PRODUSE - GRID PROFESIONAL (stil eMag/bsgmag)
   ============================================ */
/* Grid egal pe toate rezoluțiile */
...
/* Card-ul interior: flex column full height */
...
/* Zona detalii: flex column, crește */
...
/* Conținut (titlu + brand): crește ca să împingă prețul jos */
...
.woocommerce ul.products li.product .mf-product-content .woocommerce-loop-product__title,
...
/* Preț împins jos cu auto margin */
...
.woocommerce ul.products li.product .footer-button .add_to_cart_button,
...
.woocommerce ul.products li.product .footer-button .button:hover,
.woocommerce ul.products li.product .footer-button .add_to_cart_button:hover {
    background: #2563eb !important;
}

/* Butoane quick view / wishlist / compare - icon-uri mici */
.woocommerce ul.products li.product .footer-button .yith-wcwl-add-to-wishlist,
.woocommerce ul.products li.product .footer-button .compare-button,
.woocommerce ul.products li.product .footer-button .quick-view-btn {
...
/* Ascunde hover overlay care acoperă cardul */
.woocommerce ul.products li.product .mf-product-details-hover {
    display: none !important;
}

/* Fix: product list view */
.woocommerce ul.products.product-list li.product .product-inner {
    flex-direction: row !important;
    height: auto !important;
}

.woocommerce ul.products.product-list li.product .mf-product-thumbnail {
...
/* ============================================
   ...
   ============================================ */
/* Butoanele din card sunt mereu vizibile (nu hover-only) */
.woocommerce ul.products li.product .footer-button,
...
/* Butoane hover pe thumbnail (quick view, wishlist pe imagine) */
.woocommerce ul.products li.product .mf-product-thumbnail .quick-view-btn,
...
.woocommerce ul.products li.product:hover .mf-product-thumbnail .quick-view-btn,
.woocommerce ul.products li.product:hover .mf-product-thumbnail .yith-wcwl-add-to-wishlist,
.woocommerce ul.products li.product:hover .mf-product-thumbnail .compare-button {
    opacity: 1 !important;
}

/* Pe mobil – butoane mereu vizibile */
